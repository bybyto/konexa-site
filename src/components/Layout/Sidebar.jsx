...
const Sidebar = () => {
  ...
  return (
    <div className="bg-white border-r border-gray-200 h-[calc(100vh-4rem)] w-64 fixed top-16 left-0">
      <div className="p-4">
        <ul className="space-y-2">
          {navItems.map((item, index) => (
            <li key={index}>
              <Link
                to={item.path}
                className={`flex items-center p-3 text-gray-700 rounded-lg transition-all duration-200 ${
              ...
              >
                ...
                {item.path === '/messaging' && hasUnreadMessages && (
